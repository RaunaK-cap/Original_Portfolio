        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <div className="flex flex-col gap-6 w-full">
            ...
            <div className="flex flex-col gap-4 text-gray-500 dark:text-gray-300 text-sm  leading-relaxed w-full">
              ...
              <motion.p variants={textReveal}>
                In my free time, I dive into <strong className="text-gray-900 dark:text-white font-medium"> disturbuted async backend AI / Tech research papers</strong>, explore new tech with <strong className="text-gray-900 dark:text-white font-medium">Rust</strong>, and build intelligent systems. I also take on side work <strong className="text-gray-900 dark:text-white font-medium">repairing electronic hardware</strong> and peripherals.
              </motion.p>
